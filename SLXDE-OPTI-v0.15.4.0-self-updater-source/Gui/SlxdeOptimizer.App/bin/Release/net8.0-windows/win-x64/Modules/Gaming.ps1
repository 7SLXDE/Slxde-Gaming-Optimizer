...
function Get-GamingAnalysis {
    ...
    switch ($WinOpt) {
        "Enabled"  { Write-Status "Windowed Optimisations" $WinOpt "Green" }
        "Disabled" { Write-Status "Windowed Optimisations" $WinOpt "Yellow" }
        default    { Write-Status "Windowed Optimisations" $WinOpt "Yellow" }
    }
