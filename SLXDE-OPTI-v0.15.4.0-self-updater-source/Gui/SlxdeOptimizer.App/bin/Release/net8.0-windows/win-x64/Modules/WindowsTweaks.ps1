...
function Show-WindowsTweaksMenu {
    ...
    while ($true) {
        ...
        Write-Host "  3. Disable Background Apps"
        Write-Host "  4. Disable Location Tracking"
        Write-Host "  5. Disable USB Power Saving"
        Write-Host "  6. Disable Startup Apps Delay"
        Write-Host "  7. Open Max Refresh Rate Settings"
        Write-Host "  8. Open Startup Apps Settings"
        Write-Host ""
        ...
        switch ($Choice.ToUpper()) {
            ...
            "3" { Write-Status "Disable Background Apps" (Disable-BackgroundApps) "Green"; Pause-App }
            "4" { Write-Status "Disable Location" (Disable-LocationTracking) "Green"; Pause-App }
            "5" { Write-Status "Disable USB Power Saving" (Disable-USBPowerSaving) "Green"; Pause-App }
            "6" { Write-Status "Disable Startup Delay" (Disable-StartupDelay) "Green"; Pause-App }
            "7" { Write-Status "Display Settings" (Open-DisplaySettings) "Yellow"; Pause-App }
            "8" { Write-Status "Startup Apps Settings" (Open-StartupApps) "Yellow"; Pause-App }
